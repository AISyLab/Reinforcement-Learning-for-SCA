...
possible_conv_sizes = [1, 2, 3, 25, 50]  # Choices for kernel size
possible_pool_sizes = [2, 4, 7, 25, 50]  # Choices for filter_size for an average pooling layer
...
possible_fc_sizes = [2, 4, 10, 15, 20]
